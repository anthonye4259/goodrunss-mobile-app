...
export function SocialShareButtons({ text, url = "", size = "md", showLabels = true }: SocialShareButtonsProps) {
  ...
  const handleShare = (platform: string) => {
    ...
    switch (platform) {
      ...
      case "whatsapp":
        ...
        break
      case "sms":
        window.open(`sms:?body=${encodedText}%20${encodedUrl}`)
        break
    }
  }
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <Button
        ...
        className="glass-card hover:border-primary/50 hover:glow-primary"
      >
      ...
      <Button
        ...
        className="glass-card hover:border-primary/50 hover:glow-primary"
      >
        <svg className={iconSize} viewBox="0 0 24 24" fill="#0A66C2">
      ...
      <Button
        ...
        className="glass-card hover:border-primary/50 hover:glow-primary"
      >
        <svg className={iconSize} viewBox="0 0 24 24" fill="#25D366">
      ...
      >
        ...
        {showLabels && <span className="ml-2">SMS</span>}
      </Button>
    </div>
  )
}
