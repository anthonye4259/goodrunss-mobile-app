...
export const MYRTLE_BEACH_COURTS: LaunchCourt[] = [
    ...
    {
        id: "mb-011",
        name: "Grande Dunes Tennis Club",
        address: "8700 Pinnacle Dr",
        city: "Myrtle Beach",
        state: "SC",
        zipCode: "29572",
        latitude: 33.7889,
        longitude: -78.7834,
        sportTypes: ["Pickleball", "Tennis"],
        amenities: ["Pro Shop", "Lessons", "Parking", "Restaurant", "Locker Rooms"],
        courtCount: 6,
        hasLights: true,
        surface: "synthetic",
        isPublic: false,
    ...
    },
    {
        ...
        address: "2115 Farlow St",
        city: "Myrtle Beach",
        state: "SC",
        zipCode: "29577",
        latitude: 33.7045,
        longitude: -78.8912,
        sportTypes: ["Pickleball", "Basketball", "Volleyball"],
        amenities: ["Indoor Courts", "AC", "Parking", "Pro Shop"],
        courtCount: 8,
        hasLights: true,
        surface: "wood",
        isPublic: true,
    ...
    {
        id: "mb-013",
        name: "North Myrtle Beach Park & Sports Complex",
        address: "150 Citizens Cir",
        city: "North Myrtle Beach",
        state: "SC",
        zipCode: "29582",
        latitude: 33.8234,
        longitude: -78.7123,
        sportTypes: ["Pickleball", "Tennis", "Soccer"],
        amenities: ["Parking", "Restrooms", "Concessions", "Playground"],
        courtCount: 4,
        hasLights: true,
        surface: "concrete",
        isPublic: true,
    ...
    {
        id: "mb-014",
        name: "Carolina Forest Recreation Center",
        address: "2254 Carolina Forest Blvd",
        city: "Myrtle Beach",
        state: "SC",
        zipCode: "29579",
        latitude: 33.7567,
        longitude: -78.9645,
        sportTypes: ["Pickleball", "Basketball", "Tennis"],
        amenities: ["Indoor Courts", "AC", "Gym", "Parking", "Pool"],
        courtCount: 6,
        hasLights: true,
        surface: "synthetic",
        isPublic: true,
