...
const PRACTITIONER_FEATURES: FeatureSlide[] = [
    {
        id: "follow-instructors",
        emoji: "💜",
        icon: "heart",
        color: "#8B5CF6",
        title: "Follow Your Favorite Instructors",
        subtitle: "NEVER MISS A CLASS",
        description: "Follow instructors across studios. Get notified when they teach, even at different locations. Your instructors, everywhere.",
        findAt: "Instructor Profile → Follow Button",
    },
    {
        id: "smart-waitlist",
        emoji: "⚡",
        ...
        subtitle: "AUTO-BOOK WHEN SPOTS OPEN",
        description: "Join the waitlist and we'll auto-book you when a spot opens. Or get a 5-minute flash window to claim your spot first!",
        findAt: "Class Details → Join Waitlist",
    },
    {
        id: "pro-priority",
        emoji: "👑",
        icon: "star",
        color: "#22C55E",
        title: "Pro Priority Access",
        subtitle: "$10/MONTH • SKIP THE LINE",
        description: "Pro members get priority on waitlists. When a spot opens, you get first dibs. Never miss your favorite class again.",
        findAt: "Profile → Upgrade to Pro",
    },
    {
        id: "private-sessions",
        emoji: "🧘",
        icon: "person",
        color: "#EC4899",
        title: "Book Private Sessions",
        subtitle: "1-ON-1 WITH TOP INSTRUCTORS",
        description: "Book private yoga, pilates, or meditation sessions. Choose your time, location, and instructor. Premium experience.",
        findAt: "Instructor Profile → Book Private",
    },
    {
        ...
        icon: "musical-notes",
        color: "#1DB954",
        title: "Preview Class Playlists",
        subtitle: "KNOW THE VIBE BEFORE YOU BOOK",
        description: "See the Spotify playlist for upcoming classes. EDM spin? Chill yoga? Know exactly what energy awaits you.",
        findAt: "Class Card → Playlist Badge",
    },
    {
        id: "gia",
        emoji: "✨",
        ...
        description: "Ask about stretches, find studios, discover classes—GIA learns your preferences and helps you stay consistent.",
        findAt: "Tab Bar → GIA",
        tabIcon: "sparkles",
    },
]
