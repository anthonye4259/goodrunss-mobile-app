...
// ========== PRACTITIONER (STUDIO) FEATURES ==========
const PRACTITIONER_FEATURES: FeatureSlide[] = [
    {
        id: "live-data",
        emoji: "🔴",
        icon: "pulse",
        color: "#8B5CF6",
        title: "Real-Time Studio Data",
        subtitle: "KNOW BEFORE YOU GO",
        description: "See live class capacity, wait times, and atmosphere—all reported by the community. Find your perfect practice space.",
        findAt: "Home → Nearest Venue Widget",
    },
    {
        id: "live-map",
        ...
        icon: "map",
        color: "#3B82F6",
        title: "Live Studio Map",
        subtitle: "FIND YOUR PRACTICE",
        description: "Discover yoga studios, pilates centers, and wellness spaces near you. See real-time availability and vibes.",
        findAt: "Tab Bar → Live Map",
        tabIcon: "map",
    },
    {
        ...
        subtitle: "ONE-TAP BOOKING",
        description: "Reserve your spot in yoga, pilates, barre, and meditation classes. Never miss your favorite instructor.",
        findAt: "Trainers Tab → Browse Instructors",
    },
    {
        id: "recovery",
        emoji: "❤️",
        ...
        color: "#EC4899",
        title: "Recovery Hub",
        subtitle: "OPTIMIZE YOUR WELLNESS",
        description: "Track soreness, log sleep, and get personalized recovery recommendations. Stay balanced and injury-free.",
        findAt: "Profile → Recovery Hub",
    },
    {
        id: "gia",
        emoji: "✨",
        icon: "sparkles",
        color: "#EC4899",
        title: "GIA Wellness Assistant",
        subtitle: "YOUR WELLNESS AI",
        description: "Ask about stretches, find studios, generate home workouts—GIA is your personal wellness guide.",
        findAt: "Tab Bar → GIA",
        tabIcon: "sparkles",
    },
    {
        ...
        icon: "analytics",
        color: "#06B6D4",
        title: "Daily Movement Score",
        subtitle: "TRACK YOUR JOURNEY",
        description: "See your daily activity, recovery, consistency, and social scores. Build healthy habits that stick.",
        findAt: "Home → Movement Score Widget",
    },
]
...
const INSTRUCTOR_FEATURES: FeatureSlide[] = [
    {
        ...
        description: "See session earnings, class bookings, and monthly trends. Build a sustainable teaching career.",
        findAt: "Home → Earnings Dashboard",
    },
    {
        id: "classes",
        ...
        description: "Set your availability, accept bookings, and manage your class schedule all in one place.",
        findAt: "Home → Today's Schedule",
    },
    {
        id: "students",
        emoji: "🧘",
        ...
        description: "Message students, get reviews, and build a loyal following. Your profile reaches wellness seekers.",
        findAt: "Trainers Tab → Your Profile",
    },
    {
        id: "live-map",
        ...
        icon: "map",
        color: "#3B82F6",
        title: "Find Studio Spaces",
        subtitle: "TEACH ANYWHERE",
        description: "Discover available studio spaces for your classes. See real-time availability reported by the community.",
        findAt: "Tab Bar → Live Map",
        tabIcon: "map",
    },
    {
        ...
        icon: "sparkles",
        color: "#EC4899",
        title: "GIA Teaching Assistant",
        subtitle: "AI FOR INSTRUCTORS",
        description: "Get class ideas, student tips, and business advice. GIA helps you become a better teacher.",
        findAt: "Tab Bar → GIA",
        tabIcon: "sparkles",
    },
    {
        ...
        description: "Invite fellow instructors and students. Earn bonuses when they join and book.",
        findAt: "Profile → Referrals",
    },
]
