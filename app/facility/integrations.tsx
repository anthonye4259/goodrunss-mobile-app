                        ...
                        <View style={styles.connectedCard}>
                            ...
                            <View style={styles.syncStats}>
                                <View style={styles.statItem}>
                                    ...
                                    <Text style={styles.statLabel}>Every 15 min</Text>
                                </View>
                            ...
                            <View style={styles.connectedActions}>
                                <TouchableOpacity
                                    ...
                                    onPress={async () => {
                                        ...
                                        Alert.alert("Sync Started", "Courts will refresh in a moment...")
                                        loadConfig()
                                    }}
                                >
...
const styles = StyleSheet.create({
    ...
    errorText: { flex: 1, fontSize: 12, color: colors.status.error },
