    ...
    switch (userType) {
        case "trainer":
            return {
                ...
                linkType: "coach",
                benefits: [
                    "New clients book you directly",
                    "They see your profile & reviews",
        ...
        case "instructor":
            return {
                ...
                linkType: "instructor",
                benefits: [
                    "Students find your classes easily",
                    "They see your schedule & ratings",
                    "You both get $10 credit",
                ],
        ...
        case "both":
            return {
                ...
                benefits: [
                    ...
                    "Find clients when you want to coach",
                    "Everyone gets $10 credit",
                ],
            ...
            <SafeAreaView style={styles.safeArea} edges={["top"]}>
                ...
                <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.benefitsCard}>
                        <Text style={styles.benefitsTitle}>When they join:</Text>
