# Terms of Service for GoodRunss

**Last Updated: December 6, 2024**

## 1. Acceptance of Terms

By accessing or using the GoodRunss mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

## 2. Description of Service

GoodRunss is a platform that connects users with:
- Sports venues, courts, and facilities
- Personal trainers and coaches
- Other players and fitness enthusiasts
- AI-powered fitness assistant (GIA)
- Health and activity tracking integrations
...
- Able to form a binding contract under applicable law
...
- Honor bookings and commitments made through the App
...
### Trainer Bookings
- Bookings are contracts between you and the trainer
- Payment is processed through Stripe
- Cancellation policies vary by trainer
- GoodRunss facilitates but is not party to the booking

### Venue Bookings
- Subject to venue availability and policies
- Payment terms set by individual venues
- Cancellations subject to venue policies

### Fees
- GoodRunss may charge service fees on transactions
- All fees are clearly displayed before payment
- Fees are non-refundable except as required by law

### Refunds
- Refund eligibility determined by trainer/venue cancellation policy
- Disputes should be resolved directly with the service provider
- GoodRunss may mediate disputes but is not obligated to provide refunds

## 7. User Content

### Your Content
- You retain ownership of content you post (reviews, photos, messages)
- You grant GoodRunss a license to use, display, and distribute your content
- You represent that you have rights to content you post
...
- Removal does not waive our right to take further action
...
### Our Rights
- We may remove fraudulent or inappropriate reviews
- We may verify reviews before publication
- We do not guarantee accuracy of user reviews

## 9. Intellectual Property

### GoodRunss Property
- The App, logo, and content are owned by GoodRunss
- "GoodRunss" and our logo are trademarks
...
- This license terminates when you stop using the App or violate these Terms

## 10. Third-Party Services

### Integrations
- Apple Health, Strava, Google Maps, Stripe are third-party services
...
### GIA Services
- GIA provides fitness recommendations and information
- GIA responses are AI-generated and may not be accurate
- GIA is not a substitute for professional medical advice
- Always consult healthcare professionals for medical decisions

### Limitations
- We do not guarantee accuracy of GIA responses
- GIA should not be relied upon for critical decisions
- Use GIA at your own risk

## 12. Health and Safety

### Medical Disclaimer
- GoodRunss is not a medical service
- Consult healthcare professionals before starting exercise programs
- We are not liable for injuries or health issues
- Users exercise at their own risk

### Emergency Services
- GoodRunss is not an emergency service
...
- We do not warrant accuracy of venue or trainer information
...
- We are not liable for:
  ...
  - Injuries or damages from physical activity
  - Loss of data or business interruption
  - Actions of trainers or venue operators

## 16. Indemnification

You agree to indemnify and hold GoodRunss harmless from claims arising from:
- Your use of the App
...
### Entire Agreement
- These Terms constitute the entire agreement between you and GoodRunss
...
## 20. Trainer and Venue Provider Terms

### Additional Terms for Service Providers
If you offer services as a trainer or venue:
- You must be qualified and licensed as required by law
- You are responsible for your services and safety
- You must maintain appropriate insurance
- You agree to our service provider agreement
- You are an independent contractor, not an employee

## 21. Subscription Services (If Applicable)
...
**By using GoodRunss, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.**
